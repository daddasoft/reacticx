...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>ActionCard.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>ActionCardWrapper.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>ActionCardTitle.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>ActionCardSubtitle.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <SiTypescript  />
  <h3 style={{ fontWeight: "bold"}}>ActionCard.types.ts</h3>
</div>
